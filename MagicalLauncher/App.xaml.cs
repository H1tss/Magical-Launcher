...
namespace MagicalLauncher
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "MagicalLauncher-QA";
#else
        public const string ProjectName = "MagicalLauncher";
#endif
        public const string ProjectOwner = "MagicalLauncher";
        public const string ProjectRepository = "Halo-tuff/Magical-Launcher";
        public const string ProjectDownloadLink = "https://github.com/Halo-tuff/Magical-Launcher/releases";
        public const string ProjectHelpLink = "https://github.com/Halo-tuff/Magical-Launcher/wiki/help/";
        public const string ProjectSupportLink = "https://github.com/Halo-tuff/Magical-Launcher/issues/new";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructMagicalLauncherWebUrl();
        ...
        public static string ConstructMagicalLauncherWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "services.magicallauncher.com";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"services-{sub}.magicallauncher.com";
        }
